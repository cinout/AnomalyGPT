...
def parser_args():
    ...
    parser.add_argument(
        "--vicuna_ckpt_path", type=str
    )  # the path that stores the vicuna checkpoint
    parser.add_argument(
...
def main(**args):
    ...
    # TODO: to understand this load_supervised_dataset_with_cn() function
    ...
    for epoch_i in tqdm(range(args["epochs"])):
        ...
        for batch, batch_sft in zip(train_iter, train_iter_sft):
            iter_every_epoch += 1
            # try:
            # TODO: how does train_model() work?
...
if __name__ == "__main__":
    args = parser_args()
    args = vars(args)
    args["layers"] = [7, 15, 23, 31]  # TODO: what are layers?
    main(**args)
